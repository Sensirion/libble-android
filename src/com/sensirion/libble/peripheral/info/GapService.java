...
public class GapService extends AbstractInfoService {
    ...
    private static final String UUID_RECONNECTION_ADDRESS = "00002a03-0000-1000-8000-00805f9b34fb";
    ...
    static {
        ...
        CHARACTERISTIC_MAP.put(UUID_RECONNECTION_ADDRESS, "Reconnection address");
