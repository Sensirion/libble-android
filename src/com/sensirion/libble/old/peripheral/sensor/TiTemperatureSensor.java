...
public class TiTemperatureSensor extends AbstractSensor<float[]> {
    ...
    private static final String TAG = TiTemperatureSensor.class.getSimpleName();
    ...
    public float[] parse(BluetoothGattCharacteristic c) {
         ...
         * target or IR) Temperature, and Ambient ( AKA die ) temperature. Both
         * need some conversion, and Object temperature is dependent on Ambient
         * temperature. They are stored as [ObjLSB, ObjMSB, AmbLSB, AmbMSB] (4
         * bytes) Which means we need to shift the bytes around to get the
         * correct values.
         */
