...
public class Peripheral implements BleDevice, Comparable<Peripheral> {
    ...
    private final Queue<BluetoothGattCharacteristic> mLastCharacteristicsUsedQueue = new LinkedBlockingQueue<BluetoothGattCharacteristic>();
    ...
    //Listener list
    private final Set<PeripheralService> mServices = new CopyOnWriteArraySet<PeripheralService>();
    ...
    public Iterable<String> getDiscoveredPeripheralServices() {
        final Set<String> discoveredServices = new HashSet<String>();
    ...
    public boolean equals(final Object o) {
        return o instanceof Peripheral && mAddress.equals(((Peripheral) o).getAddress());
    }
     ...
     */
    @Override
    public int compareTo(final Peripheral anotherPeripheral) {
