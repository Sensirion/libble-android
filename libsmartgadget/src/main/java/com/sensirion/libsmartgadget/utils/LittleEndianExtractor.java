...
public final class LittleEndianExtractor {
    ...
    public static int extractLittleEndianIntegerFromCharacteristic(@NonNull final BluetoothGattCharacteristic characteristic) {
        return extractLittleEndianIntegerFromCharacteristicValue(characteristic.getValue());
    }

    public static int extractLittleEndianIntegerFromCharacteristicValue(@NonNull final byte[] value) {
    ...
    public static long extractLittleEndianLongFromCharacteristic(@NonNull final BluetoothGattCharacteristic characteristic) {
        return extractLittleEndianLongFromCharacteristicValue(characteristic.getValue());
    }

    public static long extractLittleEndianLongFromCharacteristicValue(@NonNull final byte[] value) {
    ...
    public static float extractLittleEndianFloatFromCharacteristic(@NonNull final BluetoothGattCharacteristic characteristic, final int offset) {
        return extractLittleEndianFloatFromCharacteristicValue(characteristic.getValue(), offset);
    }

    /**
     * Extracts a Little Endian Float from a characteristic's value.
     *
     * @param value  value that contains the little endian Float.
     * @param offset of the float value inside the characteristic.
     * @return {@link Float} with the extracted value.
     */
    public static float extractLittleEndianFloatFromCharacteristicValue(@NonNull final byte[] value, final int offset) {
     ...
     * @return {@link Integer} with the short unsigned value.
     */
